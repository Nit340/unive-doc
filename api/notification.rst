...
For assistance with notification channels:

- **Email**: channels-support@univagateway.com
- **Documentation**: https://docs.univagateway.com/api/channels
- **Status Page**: https://status.univagateway.com
- **API Reference**: https://api.univagateway.com/docs/channels
- **Community Forum**: https://community.univagateway.com/c/channels
...
- **Minimum Gateway Version**: 2.5.0
- **Compatible Alert Messages API**: 1.0.0+